...
import com.askew.sean.mealplanner.recipeviewactivity.RecipeViewActivity;

public class MealViewMenu {
    ...
    public MealViewMenu(AppCompatActivity activity, Context context, int contentView) {
